<?php
    ...
    $username = isset($_SESSION['nam'])?$_SESSION['nam']:"" ;
...
<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/background1.jpg');">
  <section id="testimonials" class="hoc container clear"> 
    <!-- ################################################################################################ -->
    <h2 class="font-x3 uppercase btmspace-80 underlined">Registration Authority <a href="#">Login Page</a></h2>
...
<tr>
<form name="form1" method="post" action="checklogin-authority.php" onSubmit="return loginValidate(this)">
<td>
...
<td style="color:#000000"; width="294"><input name="username" type="text" id="username"></td>
</tr>
<tr>
