    ...
    <ul class="nospace group">
      <li class="one_half">
		...
		<?php
			...
			$sql1="SELECT * FROM tbmembers WHERE voter_id='$myusername' and password='$encrypted_mypassword' and candi_status = '-1' and is_candidate='1'";
			...
			else
			{
				...
				$sql2="SELECT * FROM tbmembers WHERE voter_id='$myusername' and password='$encrypted_mypassword' and is_candidate='0'";
				...
				$sql2="SELECT * FROM tbmembers WHERE voter_id='$myusername' and password='$encrypted_mypassword' and candi_status='0'";
				$result2= $mysqli->query($sql2) or die(mysqli_error());
				$count2=mysqli_num_rows($result2);
				if($count2 > 0)
				{
				...
				$sql="SELECT * FROM tbmembers WHERE voter_id='$myusername' and password='$encrypted_mypassword' and candi_status = '1' and is_candidate='1'" or die(mysqli_error());
				...
				if($count==1){
					...
					// $_SESSION['member_id'] = $user['first_name'];
					// $curr_member = $user['first_name'];
