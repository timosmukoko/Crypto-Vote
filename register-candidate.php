  ...
  <header id="header" class="hoc clear"> 
    ...
    <nav id="mainav" class="fl_right">
      <ul class="clear">
		...
		<li><a href="register-candidate.php">Register Candidates</a> 
...
<div  >
  <?php
	...
	$max = 900;
	  ...
	  {
		$isCandidate = 1;
  		$sql="INSERT INTO tbmembers(first_name, last_name, email, voter_pin, voter_id, password, is_candidate, ) VALUES ('$myFirstName','$myLastName', '$myEmail', '$myVoterid', '$pin', '$newpass', '$isCandidate')";
		$result = $mysqli->query($sql)  or die(mysqli_error());
...
<tr>
<form name="form1" method="post" enctype="multipart/form-data" action="register-candidate.php" onSubmit="return registerValidate(this)">
<td>
